	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 languages hidden-xs hidden-sm">
				<?php if (lang('code') == 'es'): ?><a
					href="<?= site_url('en/' . implode('/', array_slice($this->uri->segments, 1))); ?>"><img
						src="<?= base_url('static/theme/img/flags/en.png') ?>"/> English</a><?php endif; ?>
				<?php if (lang('code') == 'en'): ?><a
					href="<?= site_url('es/' . implode('/', array_slice($this->uri->segments, 1))); ?>"><img
						src="<?= base_url('static/theme/img/flags/es.png') ?>"/> Español</a><?php endif; ?>
			</div>
			...
			<nav class="col-md-8">
				<?php if (lang('code') == 'es'): ?><a
					href="<?= site_url('en/' . implode('/', array_slice($this->uri->segments, 1))); ?>"
					class="hidden-md hidden-lg"><img src="<?= base_url('static/theme/img/flags/en.png') ?>"/> English
					</a><?php endif; ?>
				<?php if (lang('code') == 'en'): ?><a
					href="<?= site_url('es/' . implode('/', array_slice($this->uri->segments, 1))); ?>"
					class="hidden-md hidden-lg"><img src="<?= base_url('static/theme/img/flags/es.png') ?>"/> Español
					</a><?php endif; ?>
...
<footer>
	<div class="container">Powered by <a href="http://www.codeigniter.com/" target="_blank">CodeIgniter</a> - <a
			href="https://github.com/fcarribero/website" target="_blank">Github.com</a></div>
</footer>

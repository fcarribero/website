<div class="home">
    <div class="row home-top text-center">
        ...
        <div class="home-subtitle hidden-sm hidden-xs hidden-md"><?= lang('home_subtitle') ?> <span class="home-dd" data="<?= lang('msg_web_systems') ?>, <?= lang('msg_web_sites') ?>, <?= lang('msg_intranets') ?>, <?= lang('msg_extranets') ?>, <?= lang('msg_web_portals') ?>"></span></div>

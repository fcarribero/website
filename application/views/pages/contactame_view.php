<div class="contact">
	<div class="row">
		<div class="col-md-8">
			...
			<form action="" class="form">
				...
				<div class="form-group">
					...
					<textarea class="form-control" name="mensaje" required="required"
		...
		<div class="col-md-4">
			<div class="contact-location"><i class="fa fa-map-marker"></i> Capital Federal, Buenos Aires, Argentina
			</div>
			<div class="contact-phone"><i class="fa fa-phone"></i> <a href="callto:+5491164871203">+54 9 11
					6487-1203</a></div>
			<div class="contact-mail"><i class="fa fa-envelope"></i> <a href="mailto:francisco.carribero@webneex.com">francisco.carribero@webneex.com</a>
			</div>
		</div>
	</div>
</div>
